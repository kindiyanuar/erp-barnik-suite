...
# 1. Clone aplikasi (Gunakan repo kindiyanuar untuk aplikasi custom, dan frappe untuk dependensi payments)
...
# 2. Pasang package python menggunakan pip virtualenv bench
